...
def getBatteryDetails(request):
    ...
    try:
        ...
        return render(request,'battery_details.html')
...
def updateBatteryDetails(request, id):
    try:
        ...
        messages.warning(request,"Internal server error")
        return render(request,'update_battery_details.html',{'form': []})
...
def deleteRecord(request,id):
    try:
        ...
        messages.warning(request,"Error While deleting Record")
        return render(request, "battery_details.html", context)
...
def getVehicleDetails(request):
    try:
        ...
        messages.warning(request,"Internal server error")
        return render(request,'list_vehicle_details.html')
...
def assignedBatteryList(request,id):
    ...
    try:
        ...
        if request.method == "POST": 
            data = listAssignedBatteryVehicle(id)
            Vehicle.objects.filter(chasis_number=id)
            for x in data:
        ...
        messages.warning(request,"Internal server error")
        return render(request,'list_assigned_battery.html')
def assignedOrgVehicleList(request,id):
    try:
        ...
        messages.warning(request,"Internal server error")
        return render(request,'list_organisation_vehicle.html')
...
def assignedVehicleToUser(request,id):
    try:
        ...
        messages.warning(request,"Internal server error")
        return render(request,'list_assigned_vehicle_to_user.html')
